...
"/blog/enneagram-types-explained": {
  ...
  "/blog/disc-personality-types-explained": {
    ...
    sections: [
      { heading: "What DISC Measures", text: "DISC is a behavioral framework that describes how you act and communicate across four dimensions: Dominance, Influence, Steadiness, and Conscientiousness. Unlike personality models that explore your deep motivations (like the Enneagram), DISC focuses on observable behavior — what people can actually see you do. That makes DISC one of the most practical frameworks for the workplace. When you know your DISC style, you can communicate more effectively, reduce conflicts, and build stronger teams. When you know someone else's style, you can adapt your approach to work better with them." },
      { heading: "Dominance (D) — The Direct Style", text: "Core priority: Results and control. High D individuals are driven by a need to achieve and maintain control. They want to get things done quickly. Key traits: Decisive, competitive, confident, direct, willing to take risks, independent. Communication style: Bottom-line oriented. Under stress: Can become blunt, impatient, or dismissive. Growth edge: Learning to slow down, listen, and consider others' perspectives before acting. Best work environments: Sales leadership, entrepreneurship, executive management, project management, crisis-driven roles." },
      { heading: "Influence (I) — The Outgoing Style", text: "Core priority: Relationships and enthusiasm. High I individuals are naturally social and persuasive. They build connections easily and bring energy to group settings. Key traits: Enthusiastic, optimistic, persuasive, collaborative, expressive, sociable. Communication style: Story-driven and relational. Under stress: Can become disorganized, over-commit, or avoid difficult conversations. Growth edge: Developing follow-through, managing time effectively, and delivering difficult feedback with care. Best work environments: Sales, marketing, public relations, training, event planning, customer-facing roles." },
      { heading: "Steadiness (S) — The Reliable Style", text: "Core priority: Stability and harmony. High S individuals are patient, dependable, and genuinely invested in the well-being of the group. They create environments where people feel safe. Key traits: Patient, reliable, supportive, consistent, good listeners, team-oriented. Communication style: Warm and measured. Under stress: Can become passive, indecisive, or resistant to change. Growth edge: Learning to advocate for their own needs, embracing change proactively, and voicing concerns before they escalate. Best work environments: HR, nursing, education, administrative coordination, customer support." },
      { heading: "Conscientiousness (C) — The Analytical Style", text: "Core priority: Accuracy and quality. High C individuals are detail-oriented thinkers who ensure work meets a high standard. They analyze information thoroughly and follow processes carefully. Key traits: Analytical, detail-oriented, systematic, cautious, quality-focused, logical. Communication style: Precise and data-driven. Under stress: Can become perfectionistic, overly critical, or paralyzed by analysis. Growth edge: Learning to make decisions with incomplete information and communicating findings more concisely. Best work environments: Software engineering, data analysis, accounting, research, quality assurance, compliance, technical writing." },
      { heading: "DISC Combinations and Blends", text: "Most people do not fall neatly into one DISC style. Your DISC profile shows the relative strength of all four dimensions, and the combination of your top two styles creates a unique behavioral pattern. Common blends include: D/I (Results-Oriented Influencer — direct and enthusiastic), D/S (Patient Achiever — decisive but considerate), D/C (Precise Driver — demanding and detail-oriented), I/S (Collaborative Connector — warm and supportive), I/C (Thoughtful Persuader — analytical but socially skilled), and S/C (Reliable Specialist — patient, detail-oriented, and consistent)." },
      { heading: "Using DISC for Team Building", text: "DISC is one of the most widely used frameworks for team development because it is practical, easy to understand, and immediately actionable. Map your team's DISC styles by having everyone take the free assessment. Adapt your communication — if you are a High I talking to a High C, skip the stories and bring data. Assign roles strategically — put High D styles on stretch goals, High I styles on client-facing work, High S styles on consistency-focused projects, and High C styles on accuracy-demanding tasks. Address style clashes directly — the most common conflicts come from D vs S (speed vs stability) and I vs C (enthusiasm vs accuracy)." },
      { heading: "DISC for Personal Growth", text: "Your DISC profile is not a label — it is a starting point for growth. High D: Practice patience and listening — before making a decision, ask one more question. High I: Practice follow-through and directness — when you commit to something, track it. High S: Practice assertiveness and initiative — write down one thing you want to say in each meeting. High C: Practice decisiveness and concise communication — set a time limit for decisions and share conclusions first. The goal is not to change your style — it is to expand your range." },
    ],
  },
};
