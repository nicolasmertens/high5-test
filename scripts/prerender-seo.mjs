...
"/blog/disc-test-team-building": {
  ...
  "/blog/enneagram-types-explained": {
    ...
    sections: [
      ...
      { heading: "Type 2 — The Helper", text: "Core motivation: To feel loved and needed by others. Twos are warm, empathetic, and genuinely invested in the well-being of others. Strengths: Empathy, relationship-building, generosity, emotional intelligence. Growth direction (toward 4): When healthy, Twos become self-aware, emotionally honest, and creative. Stress direction (toward 8): Under pressure, Twos become demanding and resentful. Best work environments: Counseling, nursing, HR, customer success, coaching, community management." },
      { heading: "Type 3 — The Achiever", text: "Core motivation: To be successful, admired, and valuable. Threes are energetic, ambitious, and highly focused on results. Strengths: Goal-setting, efficiency, adaptability, presentation skills, driving results under pressure. Growth direction (toward 6): When healthy, Threes become cooperative, loyal, and committed to others. Stress direction (toward 9): Under pressure, Threes become apathetic and disengaged. Best work environments: Sales, entrepreneurship, management consulting, marketing, executive leadership." },
      { heading: "Type 4 — The Individualist", text: "Core motivation: To be unique, authentic, and emotionally fulfilled. Fours are creative, emotionally deep, and driven by a need for authenticity. Strengths: Creativity, emotional intelligence, authenticity, depth of feeling. Growth direction (toward 1): When healthy, Fours become disciplined, principled, and objective. Stress direction (toward 2): Under pressure, Fours become clingy and dependent on others' validation. Best work environments: Design, writing, art direction, UX research, therapy, music, brand strategy." },
      { heading: "Type 5 — The Investigator", text: "Core motivation: To understand, observe, and master knowledge. Fives are analytical, independent, and deeply curious. Strengths: Deep analysis, objectivity, independence, concentration, ability to synthesize complex information. Growth direction (toward 8): When healthy, Fives become decisive, confident, and engaged. Stress direction (toward 7): Under pressure, Fives become scattered and overconsume information. Best work environments: Software engineering, data science, research, technical writing, cybersecurity, specialized consulting." },
      { heading: "Type 6 — The Loyalist", text: "Core motivation: To be secure, supported, and prepared. Sixes are responsible, loyal, and vigilant. Strengths: Planning, risk assessment, loyalty, preparation, seeing all sides of a problem. Growth direction (toward 9): When healthy, Sixes become trusting, peaceful, and internally grounded. Stress direction (toward 3): Under pressure, Sixes become image-driven and competitive. Best work environments: Risk management, project management, healthcare administration, legal compliance, emergency services, quality assurance." },
      { heading: "Type 7 — The Enthusiast", text: "Core motivation: To experience joy, variety, and possibility. Sevens are optimistic, energetic, and endlessly curious. Strengths: Ideation, adaptability, enthusiasm, rapid learning, connecting disparate ideas. Growth direction (toward 5): When healthy, Sevens become focused, depth-oriented, and observant. Stress direction (toward 1): Under pressure, Sevens become rigidly perfectionistic and judgmental. Best work environments: Entrepreneurship, product management, events, content creation, consulting, media production." },
      { heading: "Type 8 — The Challenger", text: "Core motivation: To be strong, in control, and self-reliant. Eights are direct, decisive, and protective. Strengths: Decisiveness, courage, protective instincts, resilience, ability to make hard calls under pressure. Growth direction (toward 2): When healthy, Eights become empathetic, generous, and caring. Stress direction (toward 5): Under pressure, Eights withdraw, hoard information, and become suspicious. Best work environments: Executive leadership, law, entrepreneurship, military, crisis management, negotiation-heavy roles." },
      { heading: "Type 9 — The Peacemaker", text: "Core motivation: To be at peace, in harmony, and connected. Nines are calm, empathetic, and naturally skilled at seeing all perspectives. Strengths: Empathy, conflict resolution, inclusivity, patience, ability to synthesize multiple viewpoints. Growth direction (toward 3): When healthy, Nines become energetic, focused, and self-directed. Stress direction (toward 6): Under pressure, Nines become anxious, indecisive, and doubt their own judgment. Best work environments: Mediation, HR, counseling, environmental work, teaching, healthcare, community organizing." },
