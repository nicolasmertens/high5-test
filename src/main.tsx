      ...
      <BrowserRouter>
        <AnalyticsProvider>
          <Routes>
            ...
            />
            <Route
              path="/blog/disc-vs-16-personalities"
              element={<BlogPage slug="disc-vs-16-personalities" />}
            />
            <Route
              path="/blog/16-personalities-vs-enneagram"
            ...
            />
            <Route
              path="/blog/enneagram-type-8-challenger"
              element={<BlogPage slug="enneagram-type-8-challenger" />}
            />
            <Route
              path="/blog/disc-type-c-conscientiousness"
              element={<BlogPage slug="disc-type-c-conscientiousness" />}
            />
            <Route
              path="/blog/16-personalities-career-guide"
              element={<BlogPage slug="16-personalities-career-guide" />}
            />
            <Route
              path="/blog/enneagram-type-1-reformer"
              element={<BlogPage slug="enneagram-type-1-reformer" />}
            />
            <Route
              path="/blog/enneagram-type-2-helper"
              element={<BlogPage slug="enneagram-type-2-helper" />}
            />
            <Route
              path="/blog/personality-test-for-addiction-recovery"
              element={<BlogPage slug="personality-test-for-addiction-recovery" />}
            />
            <Route
              path="/blog/enneagram-type-4-individualist"
              element={<BlogPage slug="enneagram-type-4-individualist" />}
            />
            <Route
              path="/blog/enneagram-type-5-investigator"
              element={<BlogPage slug="enneagram-type-5-investigator" />}
            />
            <Route
              path="/blog/enneagram-type-7-enthusiast"
              element={<BlogPage slug="enneagram-type-7-enthusiast" />}
            />
            <Route
              path="/blog/personality-test-for-job-interviews"
              element={<BlogPage slug="personality-test-for-job-interviews" />}
            />
            <Route
              path="/blog/personality-test-for-college-students"
              element={<BlogPage slug="personality-test-for-college-students" />}
            />
            <Route
              path="/blog/disc-personality-in-the-workplace"
              element={<BlogPage slug="disc-personality-in-the-workplace" />}
            />
            <Route
              path="/blog/personality-test-for-career-counselors"
              element={<BlogPage slug="personality-test-for-career-counselors" />}
            />
            <Route
              path="/blog/personality-test-for-couples-counseling"
              element={<BlogPage slug="personality-test-for-couples-counseling" />}
            />
            <Route
              path="/blog/strengths-swot-analysis"
              element={<BlogPage slug="strengths-swot-analysis" />}
            />
            <Route
              path="/blog/disc-personality-test-results"
              element={<BlogPage slug="disc-personality-test-results" />}
            />
            <Route
              path="/blog/personality-test-for-first-time-managers"
              element={<BlogPage slug="personality-test-for-first-time-managers" />}
            />
            <Route
              path="/blog/16-personalities-test-free"
              element={<BlogPage slug="16-personalities-test-free" />}
            />
            <Route
              path="/blog/personality-test-for-midlife-career-change"
              element={<BlogPage slug="personality-test-for-midlife-career-change" />}
            />
            <Route
              path="/blog/disc-conflict-management"
              element={<BlogPage slug="disc-conflict-management" />}
            />
            <Route
              path="/blog/enneagram-wing-influence"
              element={<BlogPage slug="enneagram-wing-influence" />}
            />
