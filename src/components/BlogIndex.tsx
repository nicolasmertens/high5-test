...
const CATEGORIES = [
  ...
  { label: "16 Personalities", filter: (slug: string) => slug.startsWith("16-personalities") || slug.includes("16-personalities") || slug.endsWith("-personality-type") || slug.includes("-vs-") },
